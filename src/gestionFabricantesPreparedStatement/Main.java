...
public class Main {
	...
	public static void addFabricante(Connection conn) throws SQLException {
		PreparedStatement ps = (PreparedStatement) conn.prepareStatement("INSERT INTO tutorialjavacoches.fabricante (id, cif, nombre) VALUES  (?,?,?)");
		int registrosInsertados, contRegistrosInsertados = 0;
		Scanner sc = new Scanner(System.in);
	...
	public static void deleteFabricante(Connection conn) throws SQLException {
		...
		String sql = "DELETE FROM tutorialjavacoches.fabricante F WHERE F.id = ?;";
